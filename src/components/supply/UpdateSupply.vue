<template>
  <fish-form class="supplyForm" ref="updateSupply">
    ...
    <fish-fields>
      ...
      >
        <fish-input-number
          v-model="postBody.supplier.supplierID"
        ></fish-input-number>
      </fish-field>
    </fish-fields>
    <fish-fields>
      <fish-field
        label="Введите коэффициент брака"
        span="12"
        name="marriageRate"
        :rules="[
          { required: true, message: 'данное поле не должно быть пустым' }
    ...
    <fish-fields>
      <fish-field
        label="Введите таможенное оформление"
        span="12"
      ...
      >
        <fish-input-number
          v-model="postBody.customsClearance"
        ></fish-input-number>
      </fish-field>
    </fish-fields>
    <fish-fields>
...
export default {
  ...
  methods: {
    submitHandler() {
      axios
        .patch("http://localhost:8081/supplyUpdate", {
